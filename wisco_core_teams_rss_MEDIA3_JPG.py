...
#!/usr/bin/env python3
Wisconsin Sports Aggregator RSS — Packers, Bucks, Brewers, Badgers (MEDIA3 • JPG)
-------------------------------------------------------------------------------------
...
Usage (local test):
  python wisco_core_teams_rss_MEDIA3_JPG.py --out wisconsin-sports.xml --days 6 --max-items 240 --live-final-only --prefer-event-photos --scrape-og --fallback-base-url "https://<user>.github.io/wisconsin-sports-feed"
